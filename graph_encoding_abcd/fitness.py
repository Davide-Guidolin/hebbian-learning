...
def evaluate_classification(model, data_loader, abcd_params=None, pop_index=-1, shared_dict=None, device='cuda', abcd_learning_rate=0.1, agg_func=torch.max, bp_last_layer=False, bp_lr=0.00001, bp_loss=nn.CrossEntropyLoss, softhebb_train=False, softhebb_lr=0.001):
    if pop_index != -1:
